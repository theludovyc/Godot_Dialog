...
static func start(timeline_name: String, reset_saves: bool=true, dialog_scene_path: String="res://addons/GDialog/Dialog.tscn", debug_mode: bool=false, use_canvas_instead=true):
...
## @param debug_mode			Debug is disabled by default but can be enabled if needed.
## @returns						A Dialog node to be added into the scene tree.
static func start_from_save(initial_timeline: String, dialog_scene_path: String="res://addons/GDialog/Dialog.tscn", debug_mode: bool=false):
