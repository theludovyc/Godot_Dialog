...
func load_theme(theme: ConfigFile):
	...
	# Backgrounds
	$TextureRect.texture = GDialog_Util.path_fixer_load(theme.get_value('background','image', "res://addons/GDialog/Example Assets/backgrounds/background-2.png"))
	...
	next_indicator.texture = GDialog_Util.path_fixer_load(theme.get_value('next_indicator', 'image', 'res://addons/GDialog/Example Assets/next-indicator/next-indicator.png'))
	...
	$NameLabel/TextureRect.texture = GDialog_Util.path_fixer_load(theme.get_value('name','image', "res://addons/GDialog/Example Assets/backgrounds/background-2.png"))
	...
	# Setting typing SFX
	var sound_effect_path = theme.get_value('typing_sfx', 'path', "res://addons/GDialog/Example Assets/Sound Effects/Keyboard Noises")
