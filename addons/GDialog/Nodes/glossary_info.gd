...
func load_theme(theme):
	...
	$VBoxContainer/Title.set(
		...
		GDialog_Util.path_fixer_load(theme.get_value('definitions', 'font', "res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres")))
	...
	$VBoxContainer/Content.set(
		'custom_fonts/normal_font', 
		GDialog_Util.path_fixer_load(theme.get_value('definitions', 'text_font', "res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres")))
	...
	$VBoxContainer/Extra.set(
		'custom_fonts/normal_font', 
		GDialog_Util.path_fixer_load(theme.get_value('definitions', 'extra_font', "res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres")))
	$VBoxContainer/Extra.set('custom_colors/default_color', theme.get_value('definitions', 'extra_color', "#c1c1c1"))
	
	set("custom_styles/panel", load(theme.get_value('definitions', 'background_panel', "res://addons/GDialog/Example Assets/backgrounds/GlossaryBackground.tres")))
