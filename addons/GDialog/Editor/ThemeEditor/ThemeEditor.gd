...
func _ready() -> void:
	...
	if get_constant("dark_theme", "Editor"):
		$VBoxContainer/HBoxContainer3/PreviewButton.icon = load("res://addons/GDialog/Images/Plugin/plugin-editor-icon-dark-theme.svg")
	else:
		$VBoxContainer/HBoxContainer3/PreviewButton.icon = load("res://addons/GDialog/Images/Plugin/plugin-editor-icon-light-theme.svg")
...
func character_picker_about_to_show():
	var characters : Array = GDialog_Util.get_character_list()
...
func setup_advanced_containers():
	use_advanced_themes = GDialog_Resources.get_settings_config().get_value('dialog', 'advanced_themes', false)
...
func load_theme(filename):
	...
	# Background
	n['theme_background_image'].text = GDialog_Resources.get_filename_from_path(theme.get_value('background', 'image', default_background))
	...
	n['theme_next_image'].text = GDialog_Resources.get_filename_from_path(theme.get_value('next_indicator', 'image', 'res://addons/GDialog/Example Assets/next-indicator/next-indicator.png'))
	...
	n['button_custom_path'].text = GDialog_Resources.get_filename_from_path(theme.get_value('buttons', 'custom_path', ""))
	...
	n['glossary_title_font'].text = GDialog_Resources.get_filename_from_path(theme.get_value('definitions', 'font', "res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres"))
	n['glossary_title_color'].color = Color(theme.get_value('definitions', 'title_color', "#ffffffff"))
	
	n['glossary_text_font'].text = GDialog_Resources.get_filename_from_path(theme.get_value('definitions', 'text_font', "res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres"))
	n['glossary_text_color'].color = Color(theme.get_value('definitions', 'text_color', "#ffffffff"))
	
	n['glossary_extra_font'].text = GDialog_Resources.get_filename_from_path(theme.get_value('definitions', 'extra_font', "res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres"))
	n['glossary_extra_color'].color = Color(theme.get_value('definitions', 'extra_color', "#ffffffff"))
	
	n['glossary_background_panel'].text = GDialog_Resources.get_filename_from_path(theme.get_value('definitions', 'background_panel', "res://addons/GDialog/Example Assets/backgrounds/GlossaryBackground.tres"))
	...
	n['theme_font'].text = GDialog_Resources.get_filename_from_path(theme.get_value('text', 'font', 'res://addons/GDialog/Example Assets/Fonts/DefaultFont.tres'))
	n['theme_font_bold'].text = GDialog_Resources.get_filename_from_path(theme.get_value('text', 'bold_font', 'res://addons/GDialog/Example Assets/Fonts/DefaultBoldFont.tres'))
	n['theme_font_italic'].text = GDialog_Resources.get_filename_from_path(theme.get_value('text', 'italic_font', 'res://addons/GDialog/Example Assets/Fonts/DefaultItalicFont.tres'))
	...
	# Name
	n['name_font'].text = GDialog_Resources.get_filename_from_path(theme.get_value('name', 'font', 'res://addons/GDialog/Example Assets/Fonts/NameFont.tres'))
	...
	n['name_image'].text = GDialog_Resources.get_filename_from_path(theme.get_value('name', 'image', 'res://addons/GDialog/Example Assets/backgrounds/background-2.png'))
	...
	n['typing_sfx_path'].text = GDialog_Resources.get_filename_from_path(theme.get_value('typing_sfx', 'path', "res://addons/GDialog/Example Assets/Sound Effects/Keyboard Noises"))
...
func create_theme() -> String:
	...
	GDialog_Resources.add_theme(theme_file)
	load_theme(theme_file)
	# Check if it is the only theme to set as default
	if GDialog_Util.get_theme_list().size() == 1:
...
func duplicate_theme(from_filename) -> void:
	...
	GDialog_Resources.duplicate_theme(from_filename, duplicate_theme)
	GDialog_Resources.set_theme_value(duplicate_theme, 'settings', 'name', duplicate_theme)
...
func _on_PreviewButton_pressed() -> void:
	for i in $VBoxContainer/Panel.get_children():
		i.free()
	var preview_dialog = GDialog_Class.start('', true, "res://addons/GDialog/Dialog.tscn", false, false)
...
func _on_Preview_text_changed() -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'text', 'preview', n['text_preview'].text)
...
func _on_generic_checkbox(button_pressed, section, key, update_preview = true) -> void:
	...
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, section, key, button_pressed)
	if update_preview:
		_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_generic_value_change(value, section, key, update_preview = true) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, section, key, value)
	if update_preview:
		_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_Font_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'text','font', path)
	n['theme_font'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview


func _on_FontOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('text', 'font', 'res://addons/GDialog/Example Assets/Fonts/DefaultFont.tres')))
...
func _on_BoldFont_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'text','bold_font', path)
	n['theme_font_bold'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview


func _on_BoldFontOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('text', 'bold_font', 'res://addons/GDialog/Example Assets/Fonts/DefaultBoldFont.tres')))
...
func _on_ItalicFont_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'text', 'italic_font', path)
	n['theme_font_italic'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview


func _on_ItalicFontOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('text', 'italic_font', 'res://addons/GDialog/Example Assets/Fonts/DefaultItalicFont.tres')))
...
func _on_NameFont_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name', 'font', path)
	n['name_font'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview


func _on_NameFontOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('name', 'font', 'res://addons/GDialog/Example Assets/Fonts/NameFont.tres')))
...
func _on_Alignment_item_selected(index) -> void:
	if loading:
		return
	if index == 0:
		GDialog_Resources.set_theme_value(current_theme, 'text', 'alignment', 'Left')
	elif index == 1:
		GDialog_Resources.set_theme_value(current_theme, 'text', 'alignment', 'Center')
	elif index == 2:
		GDialog_Resources.set_theme_value(current_theme, 'text', 'alignment', 'Right')
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_ColorPickerButton_color_changed(color) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'text','color', '#' + color.to_html())
...
func _on_ColorPickerButtonShadow_color_changed(color) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'text','shadow_color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_ShadowOffset_value_changed(_value) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'text','shadow_offset', Vector2(n['theme_shadow_offset_x'].value,n['theme_shadow_offset_y'].value))
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_TextMargin_value_changed(value) -> void:
	...
	GDialog_Resources.set_theme_value(current_theme, 'text', 'margin', final_vector)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_BoxSize_value_changed(value) -> void:
	...
	GDialog_Resources.set_theme_value(current_theme, 'box', 'size', size_value)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_background_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'background','image', path)
	n['theme_background_image'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_ColorPicker_Background_texture_modulation_color_changed(color) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'background', 'modulation_color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_BackgroundColor_ColorPickerButton_color_changed(color) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'background', 'color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_indicator_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'next_indicator','image', path)
	n['theme_next_image'].text = GDialog_Resources.get_filename_from_path(path)
	# Since people will probably want the sprite on fresh values and the default
	# ones are for the custom GDialog theme, I reset the next indicator properties
	# here so they can set the scale and offset they want.
	GDialog_Resources.set_theme_value(current_theme, 'next_indicator', 'scale', 1)
	GDialog_Resources.set_theme_value(current_theme, 'offset', 'scale', Vector2(10,10))
...
func _on_NextAnimation_item_selected(index) -> void:
	GDialog_Resources.set_theme_value(current_theme, 'next_indicator', 'animation', n['next_animation'].get_item_text(index))
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_NextOffset_value_changed(value):
	...
	GDialog_Resources.set_theme_value(current_theme, 'next_indicator', 'offset', offset_value)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_ActionOptionButton_item_selected(index) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'settings','action_key', n['theme_action_key'].text)
...
func _on_name_auto_color_toggled(button_pressed) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name', 'auto_color', button_pressed)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_name_background_color_changed(color) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name', 'background', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_name_texture_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name', 'image', path)
	n['name_image'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_ColorPicker_NameLabel_modulation_color_changed(color) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name', 'modulation_color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_name_shadow_color_changed(color) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name', 'shadow', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_name_ShadowOffset_value_changed(_value) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name','shadow_offset', 
...
func _on_name_padding_value_changed(_value) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name','name_padding', 
...
func _on_name_BottomGap_value_changed(value) -> void:
	...
	GDialog_Resources.set_theme_value(current_theme, 'name', 'bottom_gap', n['name_bottom_gap'].value)
	GDialog_Resources.set_theme_value(current_theme, 'name', 'horizontal_offset', n['name_horizontal_offset'].value)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_name_position_selected(index):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'name', 'position', index)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_ButtonSize_value_changed(value):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'buttons','fixed_size', Vector2(n['button_fixed_x'].value,n['button_fixed_y'].value))
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_ButtonOffset_value_changed(value) -> void:
	...
	GDialog_Resources.set_theme_value(current_theme, 'buttons', 'padding', final_vector)


func _on_VerticalSeparation_value_changed(value) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'buttons', 'gap', n['button_separation'].value)
...
func _on_button_texture_toggled(button_pressed) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'buttons', 'use_image', button_pressed)
...
func _on_modifier_button_image_selected(path, _target):
	...
	n['button_' + current_choice_modifier_selected].get_node('BackgroundTexture/Button').text = GDialog_Resources.get_filename_from_path(path)
	_on_choice_style_modified(current_choice_modifier_selected)
	

func _on_choice_style_modified(section):
	GDialog_Resources.set_theme_value(current_theme, 'buttons', section, n['button_' + section].get_style_array())

func _on_native_button_toggled(button_pressed) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'buttons', 'use_native', button_pressed)
...
func _on_CustomButtonsCheckBox_toggled(button_pressed):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'buttons', 'use_custom', button_pressed)
...
func _on_custom_button_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'buttons', 'custom_path', path)
	n['button_custom_path'].text = GDialog_Resources.get_filename_from_path(path)
...
func _on_Glossary_TitleFontOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('definitions', 'font', 'res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres')))


func _on_Glossary_TitleFont_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'font', path)
	n['glossary_title_font'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_Glossary_TitleColorPicker_color_changed(color):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'title_color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_Glossary_TextFont_selected(path, target):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'text_font', path)
	n['glossary_text_font'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview


func _on_Glossary_TextFontOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('definitions', 'text_font', 'res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres')))


func _on_Glossary_TextColorPicker_color_changed(color):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'text_color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_Glossary_ExtraFont_selected(path, target):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'extra_font', path)
	n['glossary_extra_font'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview


func _on_Glossary_ExtraFontOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('definitions', 'extra_font', 'res://addons/GDialog/Example Assets/Fonts/GlossaryFont.tres')))


func _on_Glossary_ExtraColorPicker_color_changed(color):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'extra_color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_Glossary_HighlightColorPicker_color_changed(color):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'color', '#' + color.to_html())
	$DelayPreviewTimer.start(0.5) # Calling a timer so the update doesn't get triggered many times
...
func _on_BGPanelOpen_pressed():
	var theme = GDialog_Resources.get_theme_config(current_theme)
	editor_reference.editor_interface.inspect_object(load(theme.get_value('definitions', 'background_panel', 'res://addons/GDialog/Example Assets/backgrounds/GlossaryBackground.tres')))


func _on_Glossary_BackgroundPanel_selected(path, target):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'definitions', 'background_panel', path)
	n['glossary_background_panel'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_typingPath_selected(path, target) -> void:
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'typing_sfx', 'path', path)
	n['typing_sfx_path'].text = GDialog_Resources.get_filename_from_path(path)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_TypingInterruptCheckBox_toggled(button_pressed):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'typing_sfx', 'allow_interrupt', button_pressed)
	_on_PreviewButton_pressed() # Refreshing the preview
...
func _on_TypingAudioBusButton_item_selected(index):
	if loading:
		return
	GDialog_Resources.set_theme_value(current_theme, 'typing_sfx', 'audio_bus', AudioServer.get_bus_name(index))
