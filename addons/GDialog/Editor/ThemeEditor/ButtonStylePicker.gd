...
var real_file_path = 'res://addons/GDialog/Example Assets/backgrounds/background-2.png'
...
func set_path(path):
	$BackgroundTexture/Button.text = GDialog_Resources.get_filename_from_path(path)
