...
func update_data():
	var settings = GDialog_Resources.get_settings_config()
...
func refresh_themes(settings: ConfigFile):
	...
	nodes['themes'].clear()
	var theme_list = GDialog_Util.get_sorted_theme_list()
	var theme_indexes = {}
	var index = 0
...
func set_value(section, key, value):
	GDialog_Resources.set_settings_value(section, key, value)
