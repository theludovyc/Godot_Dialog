...
func build_PickerMenu():
	...
	var folder_structure = GDialog_Util.get_characters_folder_structure()
...
func build_PickerMenuFolder(menu:PopupMenu, folder_structure:Dictionary, current_folder_name:String):
	...
	if menu == picker_menu.get_popup():
		...
		if event_data["type"] == GDialog.Event_Type.CharacterLeave:
	...
	var files_info = GDialog_Util.get_characters_dict()
